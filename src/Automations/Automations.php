...
class Automations
{
    ...
    {
        $url = config('activecampaign.activecampaign_url').'/api/3/automations?limit='.self::$limit.'&offset='.self::$offset;
